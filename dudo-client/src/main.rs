...
use dudo_core::{
    event_systems::process_events,
    resources::{GamePhase, TurnOrder},
    setup_game, DudoEvent, GameLoop,
};
...
fn game_loop() -> Result<()> {
    ...
    let mut turn_order = world.resource::<TurnOrder>()?;
